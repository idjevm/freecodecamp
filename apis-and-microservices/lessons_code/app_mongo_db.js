...
const MONGO_URL =
  "mongodb+srv://idjevm:Dzhoshua@123@jv-projects-wjy1n.mongodb.net/projects?retryWrites=true&w=majority";
...
var findEditThenSave = function(personId, done) {
  ...
  Person.findById(personId, (err, foundById) => {
    ...
    foundById.favoriteFoods.push(foodToAdd);

    foundById.save((err, person) => {
      if (err) {
        return console.error(err);
      }
      done(null, person);
